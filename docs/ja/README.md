...
<p align="center">
  <em><a href="https://www.quanser.com/products/rotary-flexible-link/">Quanser Rotary Flexible Link</a> — 本研究で使用した実験装置</em>
</p>
...
> **著者**: 柳澤 篤, 大木 健太郎 — 京都大学
>
> **スライド**: [ISCS 発表資料](https://atsushiyanaigsawa768.github.io/mysite/slides/iscs_slide.pdf)
...
> **再現性に関する注記**: 評価に使用するデータセットによってRMSEの絶対値は変化し得ますが、同一の評価データにおけるカーネル間の**相対的な性能順序**はほぼ一貫していることを確認しています。
