#!/usr/bin/env python3
"""
Test script for Fourier transform integration in the unified pipeline.

Demonstrates how to use both FRF and Fourier methods for frequency domain
analysis by invoking the unified pipeline with different --freq-method flags.
"""
