...
This demonstrates how to use the paper-based procedure for GP-to-FIR conversion.
"""

import numpy as np
from pathlib import Path

from src.fir_model.fir_fitting import gp_to_fir_direct_pipeline
...
def example_with_validation():
    ...
    mat_file = Path("data/fir_validation/example_data.mat")  # Adjust path as needed
...
def example_mode_comparison():
    ...
    print(f"Input: 2nd order system (wn={wn}, zeta={zeta})")
